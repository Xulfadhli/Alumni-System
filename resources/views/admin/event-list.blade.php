        ...
        {{-- <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="bg-white border rounded shadow p-4">
              ...
              <div class="p-2">
                ...
                @endif
                <div class="p-2"><a href="{{ route('admin.event-form') }}" 
                class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Add New Event</a></div>
                          ...
                          <tbody>
                            ...
                            <tr
                              ...
                              <td class="whitespace-nowrap px-6 py-4">
                                @if ($event->photo)
                                  <img src="{{ asset('images/events/' . $event->photo) }}" alt="{{ $event->name }}">
                                @else
                              ...
                              <td class="whitespace-nowrap px-6 py-4">
                                ...
                                <form method="post" action="{{ route('admin.delete-event',$event->id) }}">
                                  <input type="hidden" name="_method" value="DELETE">
                                  @csrf
                                  <a href="{{ route('admin.edit-event-form',$event->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Edit</a>
